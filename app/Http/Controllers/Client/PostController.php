...
use App\Category;
use App\Notifications\NewClientPost;
use App\Tag;
use App\Post;
use App\User;
...
class PostController extends Controller
{
    ...
    public function create()
    {
        ...
        $tags = Tag::all();
        return view('client.post.create',compact('categories','tags'));
    }
...
//            make unipue name for image
        ...
        return redirect()->route('client.post.index');
    }
    ...
    public function edit(Post $post)
    {
        ...
        $categories = Category::all();
        $tags = Tag::all();
        return view('client.post.edit',compact('post','categories','tags'));
    }
