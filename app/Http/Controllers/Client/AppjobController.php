...
class AppjobController extends Controller
{
    ...
    {
        //
        $appjobs = Appjob::latest()->get();
        return view('client.appjob.index',compact('appjobs'));
    ...
    {
        //
        return view('client.appjob.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('client.appjob.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('client.appjob.edit',compact('category'));
    }
