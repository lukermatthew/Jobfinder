        ...
        <div class="row">
          ...
          <div class="col-md-12 col-lg-8 mb-5">
            ...
            <div class="row form-group">
              ...
              <img src="{{ Storage::disk('public')->url('profile/'.Auth::user()->image) }}" width="200" height="200" alt="User" /><h5><strong>{{ Auth::user()->name }}</strong><br><i>{{ Auth::user()->email }}</i><br>{{ Auth::user()->job_title }}<br>{{ Auth::user()->jobtypecategory->name }}</h5></span>
             ...
             <div class="p-4 mb-3 bg-white">
              ...
              <p class="mb-4">{{ Auth::user()->about }}</p>
        
             
              <h4 class="mb-0">Skills/Expertise</h4>
              <p class="mb-4">{{ Auth::user()->skill }}</p>
            </div>
             ...
             <hr>
              ...
              <div class="row form-group">
                <div class="col-md-12">
                <a href="{{ Auth::user()->role->id == 3 ? route('applicant.settings') : route('applicant.settings') }}" class="btn btn-primary  py-2 px-4">Update Profile</a>
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="p-4 mb-3 bg-white">
              ...
              <p class="mb-4">{{ Auth::user()->address }}</p>

              <p class="mb-0 font-weight-bold">Phone</p>
              <p class="mb-4"><a href="#">{{ Auth::user()->phone }}</a></p>

              <p class="mb-0 font-weight-bold">Email Address</p>
              <p class="mb-4"><a href="#">{{ Auth::user()->email }}</a></p>

              <p class="mb-0 font-weight-bold">Website</p>
              <p class="mb-4"><a href="#">{{ Auth::user()->website }}</a></p>
            ...
            <div class="p-4 mb-3 bg-white">
              <h3 class="h5 text-black mb-3">Your Portpolio</h3>
              <p>{{ Auth::user()->portfolio }}</p>
              <p><a href="" class="btn btn-primary  py-2 px-4">View More</a></p>
            </div>
