...
<html lang="en">
  ...
  <body>
			              ...
			              <div class="tab-pane fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="v-pills-nextgen-tab">
			              	...
			              	<form method="GET" action="{{ route('searchjob') }}" class="search-job">
                                ...
                                <div class="icon"><span class="icon-briefcase"></span></div>
								                ...
								                <input type="text" class="form-control" value="{{ isset($query) ? $query : '' }}"   name="query" placeholder="eg. Garphic. Web Developer">
								              </div>
							              </div>
                          </div>
    ...
    <section class="ftco-section ftco-counter">
        ...
        @foreach($jobcategories as $jobcategory)<div class="container">
        <div class="row row justify-content-center">
        	<div class="col-md-10 ftco-animate">
        		<ul class="category">
        			<li><a href="#">{{ $jobcategory->name }} <span class="number" data-number="1000"></span></a></li>
        		</ul>
        	</div></div>
          </div>
          @endforeach 
      ...
      <div class="container">
        ...
        <div class="row d-flex">
          <div class="col-md-3 d-flex ftco-animate">
            ...
            <img  class="block-20" src="{{ Storage::disk('public')->url('post/'.$post->image) }}" alt="{{ $post->title }}">
              ...
              <div class="text mt-3">
                ...
                <h3 class="heading"><a href="#">{{ str_limit($post->title, $limit = 22, $end = '...') }}</a></h3>
               <p>{{ str_limit($post->body, $limit = 70, $end = '...') }}</p>
